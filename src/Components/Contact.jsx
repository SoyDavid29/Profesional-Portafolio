        ...
        <section className="contact">
            ...
            <div className="card-container">
                ...
                <div className="card">
                    ...
                    <p className="text-card" >You can send me an email, and I will respond immediately.</p>
                ...
                <div className="card">
                    ...
                    <h3>Location</h3>
                    <p className="text-card" >I work remotely from Durango, Mex, offering services throughout Mexico.</p>
                    <p className="text-card1" >Durango, Mexico.</p>
                </div>
            </div>
            ...
            <div className='form-container'>
                <div className="card">
                    ...
                    <p className="text-card">Let's talk about how can i help you!.</p>
                </div>
